...
export const LINK_BTN_STYLES =
  'w-fit block py-1 relative text-base font-light hover:underline  transition-all underline-offset-[6px] duration-300 ease-in-out cursor-pointer leading-normal';
