...
const Navbar = () => {
  ...
  return (
    <nav className='absolute top-8 left-0 right-0 z-50 w-full max-w-[840px] xl:max-w-[900px] mx-auto inline-flex justify-center px-6'>
      <div className='w-full backdrop-blur-sm bg-[#020202]/15 text-white border border-white/15 rounded-sm inline-flex justify-between gap-6 items-center p-4'>
