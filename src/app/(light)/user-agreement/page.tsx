      ...
      <section className='section-padding-x max-w-[1200px] mx-auto py-20'>
        <div className='space-y-8'>
          ...
          <div className='space-y-4 pt-4'>
            ...
            <div className='space-y-3'>
              ...
              <div>
                ...
                <p className='text-sm sm:text-base font-normal leading-relaxed'>
                  All content, software, analytics, designs, trademarks, and data
                  on the platform are owned by Seller Swift or its licensors and
                  are protected by intellectual property laws. No ownership
                  rights are transferred to you by your use of the Services.
                </p>
              </div>
              ...
              <div>
                ...
                <p className='text-sm sm:text-base font-normal leading-relaxed'>
                  ...
                  analyze, and display your data as necessary to operate and
          ...
          <div className='space-y-4 pt-4'>
            ...
            <p className='text-sm sm:text-base font-normal leading-relaxed'>
              Seller Swift reserves the right to suspend or terminate your access
          ...
          <div className='space-y-4 pt-4'>
            ...
            <p className='text-sm sm:text-base font-normal leading-relaxed'>
              ...
              Seller Swift makes no warranties, express or implied, including but
          ...
          <div className='space-y-4 pt-4'>
            ...
            <ul className='list-disc list-inside space-y-2 ml-4 text-sm sm:text-base font-normal'>
              ...
              <li>
                Seller Swift's total liability for any claim under this Agreement
                shall not exceed the amount you paid (if any) to Seller Swift for
                use of the Services during the twelve (12) months prior to the
                claim.
              </li>
            </ul>
            <p className='text-sm sm:text-base font-normal leading-relaxed'>
          ...
          {/* Section 10 */}
          <div className='space-y-4 pt-4'>
            <h2 className='text-lg sm:text-xl font-semibold'>10. Termination</h2>
            <p className='text-sm sm:text-base font-normal leading-relaxed'>
          ...
          <div className='space-y-4 pt-4'>
            ...
            <p className='text-sm sm:text-base font-normal leading-relaxed'>
              ...
              updated version will be posted on our website or platform, and your
