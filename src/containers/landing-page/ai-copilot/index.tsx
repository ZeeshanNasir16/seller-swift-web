    ...
    <section className='py-10 md:py-20'>
      <div className='section-max-width section-padding-x space-y-8 z-20 relative -mb-28'>
        ...
        <div className='relative w-[80%] mx-auto'>
          <Image
            ...
            width={1920}
            height={1080}
            sizes='(max-width: 768px) 80vw, (max-width: 1200px) 70vw, 1000px'
      ...
      >
        <div className='section-max-width section-padding-x relative z-[25]'>
          ...
          <div className='grid md:grid-cols-[1fr_150px_1fr] lg:grid-cols-[minmax(300px,470px)_minmax(250px,1fr)_minmax(300px,470px)] 2xl:grid-cols-[minmax(350px,1fr)_minmax(250px,400px)_minmax(300px,1fr)] mt-32'>
            <InsightCard
